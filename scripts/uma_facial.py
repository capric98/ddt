...
morph_dict = {
    ...
    "Mouth_54": [("口横広げ", 0.3)],
    "Eye_1_L": [("ウィンク２", 0.4)],
    "Eye_1_R": [("ｳｨﾝｸ２右", 0.4), ("ウィンク２右", 0.4)],
    "Eye_2_L": "ウィンク２",
    "Eye_2_R": [("ｳｨﾝｸ２右", 1), ("ウィンク２右", 1)],
    "Eye_3_L": [("ウィンク", 0.3)],
    "Eye_3_R": [("ウィンク右", 0.3)],
    "Eye_4_L": [("ウィンク", 0.5)],
    "Eye_4_R": [("ウィンク右", 0.5)],
    ...
    "Eye_5_R": [("ウィンク右", 1.0)],
    "Eye_6_L": [("ウィンク２", 0.1)],
    "Eye_6_R": [("ｳｨﾝｸ２右", 0.1), ("ウィンク２右", 0.1)],
    "Eye_7_L": [("ウィンク", 0.1)],
    "Eye_7_R": [("ウィンク右", 0.1)],
    "Eye_8_L": [("ウィンク", 1)],
    "Eye_8_R": [("ウィンク右", 1)],
    "Eye_9_L": [("ウィンク２", 0.05)],
    "Eye_9_R": [("ｳｨﾝｸ２右", 0.05), ("ウィンク２右", 0.05)],
    "Eye_10_L": [("ウィンク２", 0.05)],
    "Eye_10_R": [("ｳｨﾝｸ２右", 0.05), ("ウィンク２右", 0.05)],
    "Eye_11_L": [("ウィンク２", 0.08)],
    "Eye_11_R": [("ｳｨﾝｸ２右", 0.08), ("ウィンク２右", 0.08)],
    "Eye_12_L": [("びっくり1", 0.3)],
    "Eye_13_L": [("瞳小", 0.8)],
    "Eye_14_L": [("瞳小", 0.8)],
    "Eye_15_L": [("なごみ左", 0.2)],
    ...
    "Eye_16_R": "なごみ右",
    "Eye_17_L": [("ウィンク２", 0.2)],
    "Eye_17_R": [("ｳｨﾝｸ２右", 0.2), ("ウィンク２右", 0.2)],
    "Eye_18_L": [("ウィンク", 0.1)],
    "Eye_18_R": [("ウィンク右", 0.1)],
    "Eye_23_L": [("ウィンク２", 0.15)],
    "Eye_23_R": [("ｳｨﾝｸ２右", 0.15), ("ウィンク２右", 0.15)],
    "Ebrow_1_L": [("上", 0.2)],
    "Ebrow_2_L": [("下", 0.2)],
    "Ebrow_3_L": [("下", 0.8)],
    "Ebrow_4_L": "下",
